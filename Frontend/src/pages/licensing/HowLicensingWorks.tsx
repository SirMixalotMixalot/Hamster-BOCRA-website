      ...
      <main className="min-w-0 flex-1">
        <div className="bg-bocra-navy text-white py-12">
          <div className="container text-center">
            <h1 className="text-3xl md:text-4xl font-heading font-extrabold">How Licensing Works</h1>
            <p className="text-white/70 mt-2 text-sm max-w-2xl mx-auto">
              A step-by-step guide to applying for, renewing, and tracking BOCRA licences.
            </p>
          </div>
        </div>
