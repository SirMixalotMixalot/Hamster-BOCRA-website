...
import { Search, FileText, Download, Eye, X, User } from "lucide-react";
...
const AdminJobApplications = () => {
  ...
  const updateStatus = (id: string, status: JobApplicationEntry["status"]) => {
  ...
  const statusBadge = (status: JobApplicationEntry["status"]) => {
    ...
    <div className="space-y-6 max-w-6xl">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Review applications submitted through the Careers page
        </p>
      </div>
