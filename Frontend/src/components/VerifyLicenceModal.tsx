                  ...
                  <tbody>
                    {results.map((row, i) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-foreground hidden sm:table-cell">{row.licence_type}</td>
                        <td className="px-4 py-3 text-foreground hidden sm:table-cell">{formatDate(row.expiration_date)}</td>
